"use client";
import { Contact, Membership } from "@/lib/types"; // Import Contact and Membership types

interface ContactSectionProps {
  contact: Contact | null; // Expecting contact data as a prop
  memberships: Membership[]; // Expecting memberships data as a prop
}

const ContactSection = ({ contact, memberships }: ContactSectionProps) => {
  if (!contact) {
